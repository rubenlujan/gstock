...
const GananciaPorCategoria = () => {
    ...
    const handleBuscar = async () => {
        ...
        try {
            const res = await post("GetCategoryProfitByRange", {
    ...
    const handleExportPDF = () => {
        ...
        const nombreArchivo = `GananciaCategoria_${fechaInicioStr}_a_${fechaFinStr}`;


        const doc = new jsPDF();
        doc.setFontSize(14);
        doc.text(
            `Reporte de Ganancia por Categoría del ${format(fechaIni, "yyyy-MM-dd")} al ${format(fechaFin, "yyyy-MM-dd")}`,
            14,
            15
        );
        ...
        autoTable(doc, {
            head: [["Categoria", "Cantidad", "Venta", "Costo", "Ganancia"]],
            body: tableData,
            startY: 45,
        });
    ...
    const handleExportCSV = () => {
        ...
        const header = ["Categoria", "Cantidad", "Venta", "Costo", "Ganancia"];
        ...
        const resumen = [
            [`Reporte de Ganancia Por Categoria del ${format(fechaIni, "yyyy-MM-dd")} al ${format(fechaFin, "yyyy-MM-dd")}`],
            [],
            ["Resumen de Totales"],
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto bg-white rounded-xl shadow space-y-4">
            <h2 className="text-2xl font-bold text-blue-600">Ganancia por Categoría</h2>
...
export default GananciaPorCategoria;
