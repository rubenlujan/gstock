  ...
  <React.StrictMode>
    <BrowserRouter basename="/gstock/">
      <Routes>
        ...
        <Route path="/articulos/nuevo" element={
          <PrivateRoute>
            <ArticuloNuevo />
          </PrivateRoute>
        } />
        <Route path="/materiaprima/editar/:id" element={
          <PrivateRoute>
            <MateriaPrimaEditar />
          </PrivateRoute>
        } />
        <Route path="/materiaprima/nuevo" element={
          <PrivateRoute>
            <MateriaPrimaNueva />
          </PrivateRoute>
        } />
        <Route path="/docinv/editar" element={
          <PrivateRoute>
            <MovimientosInventario action={1} />
          </PrivateRoute>
        } />
        <Route path="/docinv" element={
          <PrivateRoute>
